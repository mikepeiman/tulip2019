...
export default {
  ...
  computed: {
    containerStyle() {
      return `
      background-image: linear-gradient(90deg, ${this.convert(this.accentColor, this.alpha)}, ${this.convert(this.bgColor, this.alpha)}, ${this.convert(this.accentColor, this.alpha)}), url(${this.bg});
